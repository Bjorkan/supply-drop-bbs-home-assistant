...
This Home Assistant App release packages the official [Supply Drop BBS v1.4.2](https://github.com/Mesh-America/supply-drop-bbs/releases/tag/v1.4.2).

## [1.4.2] — 2026-09-24

### Bug Fixes

- Restrict data_dir and the live database file to owner-only ([`4abb9b4`](4abb9b42eed4265ca159ecc737ae245433a00001))
- Time out a stuck pending_key_op instead of wedging future key ops ([`62da571`](62da57113f11bcc482cb9f0822692e3650159b62))
- Track the reply to CMD_SET/GET_AUTOADD_CONFIG ([`fcf97ab`](fcf97ab4728147078f7b5edd1d19e87ee15f90f2))
- Route EXDEV copy fallback through a private guarded temp file ([`595e077`](595e0775ad2280f08c6b8b34cde155b1fce25cc5))

### Chores

- Sync issue export ([`7cac479`](7cac479706e17c16f3e2baf0671c3c9274b0f1a9))

### Testing

- Exercise sidecar permissions without SQLite mmapping fake files ([`7466103`](7466103a1908ea747e4c6b97121f5851faaf0f02))
